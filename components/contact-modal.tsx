...
export default function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  return (
    <div
        className={`fixed inset-0 z-[9999] flex items-center justify-end transition-all duration-500 ${
        isAnimating ? "bg-black/50 backdrop-blur-sm" : "bg-transparent"
      }`}
    >
      <div
        ref={modalRef}
        className={`w-full md:w-1/2 h-full bg-black/90 shadow-2xl transform transition-all duration-700 ease-out overflow-y-auto z-[10000] ${
          ...
          <div className="space-y-8 flex-grow">
            ...
            >
              ...
              <div className="flex space-x-6">
                <a
                  href="https://www.instagram.com/dgprojects_?igsh=MXVpcTFyaTdoendxdA=="
